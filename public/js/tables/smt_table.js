...
function deletRow() {
    ...
    if (confirm("êtes-vous sûr de vouloir ajouter ces lignes!")) {
        $.ajax({
            url: "/SMT", // Url of backend (can be python, php, etc..)
...
//  progressiveLoad: "scroll",
    ...
    index: "medecin_travail_structure_id",
    columns: [
        {
        ...
        {
            title: "Id",
            field: "medecin_travail_structure_id",
            width: 53,
            sorter: "number",
        },
        {
...
table.on("cellEdited", function (cell) {
    json_emp["ID"] = cell.getRow().getData().medecin_travail_structure_id;
