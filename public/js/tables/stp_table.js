function deletRow() {
    ...
    if (confirm("êtes-vous sûr de vouloir ajouter ces lignes!")) {
        $.ajax({
            url: "/STP", // Url of backend (can be python, php, etc..)
...
//  progressiveLoad: "scroll",
    ...
    index: "tiers_payant_structure_id",
    columns: [
        {
        ...
        {title: "Id", field: "tiers_payant_structure_id", width: 53, sorter: "number"},
        {
            title: "Code",
            field: "code",
            width: 203,
